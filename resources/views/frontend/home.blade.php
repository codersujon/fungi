...
<body data-bs-spy="scroll" data-bs-target="#site-navbar" class="home-vcard">
	...
	<header class="site-header" id="site-header">
		<nav class="navbar navbar-expand-xl" id="site-navbar">
		  <div class="container">
		    <a class="navbar-brand" href="index.html"><img class="img-fluid" src="{{ asset('frontend') }}/image/fungi_logo.png" alt="fungi logo"></a>
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      <ul class="navbar-nav ms-auto mb-lg-0">
		        <li class="nav-item">
		          <a class="nav-link active" aria-current="page" href="#site-header"><i class="pe-7s-home"></i><span>Home</span></a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="#about-section"><i class="pe-7s-user"></i><span>About</span></a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="#portfolio-section"><i class="pe-7s-portfolio"></i><span>Portfolio</span></a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="#service-section"><i class="pe-7s-config"></i><span>Service</span></a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="#testimonial-section"><i class="pe-7s-like2"></i><span>Testimonials</span></a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="#blog-section"><i class="pe-7s-news-paper"></i><span>Blog</span></a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="#contact-section"><i class="pe-7s-mail-open"></i><span>Contact</span></a>
		        </li>
		      </ul> <!-- .navbar-nav -->
		      <ul class="nav-social">
				<li class="facebook-link"><a href="#"><i class="fab fa-facebook-f"></i></a></li>
				<li class="twitter-link"><a href="#"><i class="fab fa-twitter"></i></a></li>
				<li class="linkedin-link"><a href="#"><i class="fab fa-linkedin"></i></a></li>
				<li class="instagram-link"><a href="#"><i class="fab fa-instagram"></i></a></li>
				<li class="tiktok-link"><a href="#"><i class="fab fa-tiktok"></i></a></li>
			  </ul> <!-- .hero-social -->
		    </div> <!-- .collapse -->
		...
		<div class="box-wrapper">
			...
			<section class="hero-area" id="hero-area">
				<div class="hero-content d-flex justify-content-center">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="col-xl-10 content-block">
							<div class="image-wrapper" data-tilt data-tilt-max="10">
								<img class="img-fluid" src="{{ asset('frontend') }}/image/hero_main_image.jpg" alt="hero main image">
							</div> <!-- .image-wrapper -->
							<h1 class="hero-head"><small>Hello There, I'm</small>MD SUJAN <strong>AHMED</strong></h1>
							<p>
								Globally Recognized 
								<span class="typer" id="main" data-words="Web Developer, Web Designer, Freelancer" data-delay="100" data-deleteDelay="1000"></span>
								<span class="cursor" data-owner="main"></span>
							</p>
							<div class="link-group">
								<a class="btn-main" href="#contact-section">Hire Me</a>
								<a class="btn-ghost" href="#about-section">About Me</a>
							</div> <!-- .link-group -->
						</div> <!-- .content-block -->
					</div> <!-- .row -->
				</div> <!-- .hero-content -->
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-xl-3 col-md-6 text-center" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
							...
							<p class="number-data"><strong class="counter">950</strong><span>+</span></p>
						</div>
						<div class="col-xl-3 col-md-6 text-center" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="600">
							...
							<h3>Awards<br>Won</h3>
							<p class="number-data"><strong class="counter">19</strong></p>
						</div>
					</div> <!-- .row -->
				</div> <!-- .container -->
				...
				<div class="row">
					<div class="col-xl-6 image-block" data-aos="fade-right" data-aos-delay="200" data-aos-duration="2000">
						<div class="img-wrapper about-img-wrap" data-tilt data-tilt-max="10">
							<img class="about-img-1 img-fluid" src="{{ asset('frontend') }}/image/about-image-1.png" alt="about image">
						</div>
					</div>
					<div class="col-xl-6 content-block" data-aos="fade-right" data-aos-delay="400" data-aos-duration="2000">
						<h2><span>About Me</span>Senior Web Designer from New York</h2>
						<p>
						...
						<p>
							...
							quis nostrud exercitation ullamco laboris consequat. 
						</p>
				...
				<div class="row">
					<div class="col-xl-6 content-block" data-aos="fade-down" data-aos-duration="2000">
						...
						<p class="lead">
							...
							proident, sunt in culpa qui officia deserunt laborum.
						</p>
					</div>
			...
			<section class="portfolio-section section-block" id="portfolio-section">
				...
				<div class="row grid" data-aos="fade-up" data-aos-duration="2000">
					<div class="col-lg-4 col-md-6 grid-item programming">
						<div class="box">
				            <img src="{{ asset('frontend') }}/image/portfolio/portfolio-item-01.jpg" alt="portfolio image">
							    ...
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
							        ...
							        <div class="row item-content">
							        	<div class="col-xl-12">
							        		<img src="{{ asset('frontend') }}/image/portfolio/portfolio_large_1.jpg" alt="portfolio image">
							        	</div>
							        	<div class="col-xl-8">
							        		<div class="content-wrapper">
					...
					<div class="col-lg-4 col-md-6 grid-item development application">
						<div class="box">
				            <img src="{{ asset('frontend') }}/image/portfolio/portfolio-item-02.jpg" alt="portfolio image">
				            <div class="box-content">
							  ...
							  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
							        ...
							        <div class="row item-content">
							        	<div class="col-xl-12">
							        		<img src="{{ asset('frontend') }}/image/portfolio/portfolio_large_2.jpg" alt="portfolio image">
							        	</div>
							        	<div class="col-xl-8">
							        		<div class="content-wrapper">
								        		<h2 class="item-title">Branding for ABC Corporation</h2>
					...
					<div class="col-lg-4 col-md-6 grid-item application programming design">
						<div class="box">
				            <img src="{{ asset('frontend') }}/image/portfolio/portfolio-item-03.jpg" alt="portfolio image">
				            <div class="box-content">
							  ...
							  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
							        ...
							        <div class="row item-content">
							        	<div class="col-xl-12">
							        		<img src="{{ asset('frontend') }}/image/portfolio/portfolio_large_3.jpg" alt="portfolio image">
							        	</div>
							        	<div class="col-xl-8">
							        		<div class="content-wrapper">
								        		<h2 class="item-title">Branding for ABC Corporation</h2>
					...
					<div class="col-lg-4 col-md-6 grid-item design application">
						<div class="box">
				            <img src="{{ asset('frontend') }}/image/portfolio/portfolio-item-04.jpg" alt="portfolio image">
				            <div class="box-content">
							  ...
							  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
							        ...
							        <div class="row item-content">
							        	<div class="col-xl-12">
							        		<img src="{{ asset('frontend') }}/image/portfolio/portfolio_large_4.jpg" alt="portfolio image">
							        	</div>
							        	<div class="col-xl-8">
							        		<div class="content-wrapper">
								        		<h2 class="item-title">Branding for ABC Corporation</h2>
					...
					<div class="col-lg-4 col-md-6 grid-item programming design">
						<div class="box">
				            <img src="{{ asset('frontend') }}/image/portfolio/portfolio-item-05.jpg" alt="portfolio image">
				            <div class="box-content">
				            		<span class="category">Programming</span>
							  ...
							  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
							        ...
							        <div class="row item-content">
							        	<div class="col-xl-12">
							        		<img src="{{ asset('frontend') }}/image/portfolio/portfolio_large_5.jpg" alt="portfolio image">
							        	</div>
							        	<div class="col-xl-8">
							        		<div class="content-wrapper">
								        		<h2 class="item-title">Branding for ABC Corporation</h2>
					...
					<div class="col-lg-4 col-md-6 grid-item development design">
						<div class="box">
				            <img src="{{ asset('frontend') }}/image/portfolio/portfolio-item-06.jpg" alt="portfolio image">
				            <div class="box-content">
				            		<span class="category">Development</span>
							  ...
							  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
							        ...
							        <div class="row item-content">
							        	<div class="col-xl-12">
							        		<img src="{{ asset('frontend') }}/image/portfolio/portfolio_large_6.jpg" alt="portfolio image">
							        	</div>
							        	<div class="col-xl-8">
							        		<div class="content-wrapper">
								        		<h2 class="item-title">Branding for ABC Corporation</h2>
				...
				<div class="row">
					<div class="col-xl-4 col-lg-6" data-aos="fade-up">
						<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
							...
							<p>
								...
								cillum dolore eu fugiat nulla pan proide.
							</p>
						</div>
					</div>
					<div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="200">
						<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
							...
							<h3>Mobile Apps</h3>
							<p>
								Nulla sit amet maximus mass abitur et rerit enim iam condime justo at luctus ore pag torem comodo kobita.
							</p>
						</div>
					</div>
					<div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="400">
						<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
							...
							<p>
								Donec sed magna uspen disse males uasuda dolor sierot ectetur adip iscing elit eget ullamc dana kobita tumi.
							</p>
						</div>
					</div>
					<div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="600">
						<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
							...
							<p>
								Det esse prehen pteur sint lore eu fugiat nulla kopa samsu kopa kidye je tare pan ontor ja tumi sopno ulpa rum.
							</p>
						</div>
					</div>
					<div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="800">
						<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
							...
							<p>
								Quisque ultricies nibh eu sapien cus mattis. Ut fringilla, eros vitae consequa proide nesha sopno charini hoye.
							</p>
						</div>
					</div>
					<div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="1000">
						<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
							...
							<p>
								Aliquam aliquam mi ctor vita sellus egestas eros scelerisque suscipit impe rdiet eque nulla khobor nio na.
							</p>
						</div>
					</div>
				</div><!-- .row -->
					...
					<div class="col-lg-6 education-block" data-aos="fade-right" data-aos-duration="1500">
						...
						<ul>
							<li class="d-flex align-items-start">
								...
								<div class="content-wrapper">
									<h4>Diploma in Algorythm <span>2013-2015</span></h4>
									<h5>University of Rajshahi</h5>
									<p>
										Excepteur sint occaecat cupidatat non
										proident, sunt in culpa qui officia mollit laborum.
									</p>
								</div>
							...
							<li class="d-flex align-items-start">
								...
								<div class="content-wrapper">
									<h4>Bachelor in Computer Seience <span>2010-2013</span></h4>
							...
							<li class="d-flex align-items-start">
								...
								<div class="content-wrapper">
									<h4>Diploma in Graphic Design <span>2008-2010</span></h4>
									<h5>New York Collage</h5>
									<p>
										Excepteur sint occaecat cupidatat non
										proident, sunt in culpa qui officia mollit laborum.
									</p>
					...
					<div class="col-lg-6 education-block" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="400">
						...
						<ul>
							<li class="d-flex align-items-start">
								...
								<div class="content-wrapper">
									<h4>Project Manager <span>2019-2021</span></h4>
									<h5>Easy Computers</h5>
									<p>
										Excepteur sint occaecat cupidatat non
										proident, sunt in culpa qui officia mollit laborum.
									</p>
							...
							<li class="d-flex align-items-start">
								...
								<div class="content-wrapper">
									<h4>Full Stack Developer <span>2019-2015</span></h4>
									<h5>Rainy Design</h5>
									<p>
										Excepteur sint occaecat cupidatat non
										proident, sunt in culpa qui officia mollit laborum.
							...
							<li class="d-flex align-items-start">
								...
								<div class="content-wrapper">
									<h4>Graphic Design <span>2010-2015</span></h4>
									<h5>Xins Video</h5>
									<p>
										Excepteur sint occaecat cupidatat non
										proident, sunt in culpa qui officia mollit laborum.
					...
					<div class="swiper-wrapper">
						<div class="testimonial-item swiper-slide">
							<div class="item-wrapper">
								<div class="quote-icon">
									<img src="{{ asset('frontend') }}/image/quote-icon.png" alt="quote icon">
								</div>
								<p>
									Ut enim ad minim veniam quis nostrud nisi ut aliquip ex ea commodo consequat. Duis aute ir cm id est laborum.
								</p>
								<div class="quote-author d-flex align-items-center justify-content-center">
									<div class="image-block">
										<img class="img-fluid" src="{{ asset('frontend') }}/image/testimonial/testimonial-author-1.jpg" alt="testimonial author">
									</div>
						...
						<div class="testimonial-item swiper-slide">
							<div class="item-wrapper">
								...
								<p>
									Ut enim ad minim veniam quis nostrud kobita tumi sopno ex ea commodo consequat. Duis aute ir cm id est laborum.
								</p>
								<div class="quote-author d-flex align-items-center justify-content-center">
									<div class="image-block">
										<img class="img-fluid" src="{{ asset('frontend') }}/image/testimonial/testimonial-author-3.jpg" alt="testimonial author">
									</div>
						...
						<div class="testimonial-item swiper-slide">
							<div class="item-wrapper">
								...
								<p>
									Ut enim ad minim veniam ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute ir cm id est laborum.
								</p>
								<div class="quote-author d-flex align-items-center justify-content-center">
									<div class="image-block">
										<img class="img-fluid" src="{{ asset('frontend') }}/image/testimonial/testimonial-author-4.jpg" alt="testimonial author">
									</div>
						...
						<div class="testimonial-item swiper-slide">
							<div class="item-wrapper">
								...
								<p>
									Ut enim ad minim veniam quis ullamco laboris nisi ut aliquip ea commodo consequat. Duis aute ir cm id est laborum.
								</p>
								<div class="quote-author d-flex align-items-center justify-content-center">
									<div class="image-block">
										<img class="img-fluid" src="{{ asset('frontend') }}/image/testimonial/testimonial-author-2.jpg" alt="testimonial author">
									</div>
					...
					<div class="col-lg-6 large-post" data-aos="fade-right" data-aos-duration="1200">
						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        ...
						        <div class="row blog-content">
						        	<div class="col-xl-12">
						        		<img class="img-fluid" src="{{ asset('frontend') }}/image/blog/blog_full_01.jpg" alt="blog post image 01">
						        	</div>
						...
						<div class="content-wrapper">
							...
							<div class="image-wrapper">
								<img class="img-fluid" src="{{ asset('frontend') }}/image/blog/post-thumbnail-01.jpg" alt="post thumnail">
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
								  ...
								  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
								    <div class="modal-content">
								      ...
								      <div class="modal-body">
								        ...
								        <div class="row blog-content">
								        	<div class="col-xl-12">
								        		<img class="img-fluid" src="{{ asset('frontend') }}/image/blog/blog_full_03.jpg" alt="blog post image 02">
								        	</div>
								        	<div class="col-xl-8 offset-xl-2">
								        		<div class="content-wrapper">
								...
								<div class="content-wrapper">
									...
									<div class="image-wrapper">
										<img class="img-fluid" src="{{ asset('frontend') }}/image/blog/post-thumbnail-03.jpg" alt="post thumnail">
									</div>
								</div>
							</div>
							<div class="col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="600">
								  ...
								  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
								    <div class="modal-content">
								      ...
								      <div class="modal-body">
								        ...
								        <div class="row blog-content">
								        	<div class="col-xl-12">
								        		<img class="img-fluid" src="{{ asset('frontend') }}/image/blog/blog_full_04.jpg" alt="blog post image 03">
								        	</div>
								        	<div class="col-xl-8 offset-xl-2">
								        		<div class="content-wrapper">
									        		<h2 class="blog-title">Javascript algorythm and data structure for beginner</h2>
								...
								<div class="content-wrapper">
									...
									<div class="image-wrapper">
										<img class="img-fluid" src="{{ asset('frontend') }}/image/blog/post-thumbnail-04.jpg" alt="post thumnail">
									</div>
								</div>
							</div>
							<div class="col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="800">
								  ...
								  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
								    <div class="modal-content">
								      ...
								      <div class="modal-body">
								        ...
								        <div class="row blog-content">
								        	<div class="col-xl-12">
								        		<img class="img-fluid" src="{{ asset('frontend') }}/image/blog/blog_full_05.jpg" alt="blog post image 04">
								        	</div>
								        	<div class="col-xl-8 offset-xl-2">
								        		<div class="content-wrapper">
									        		<h2 class="blog-title">Javascript algorythm and data structure for beginner</h2>
								...
								<div class="content-wrapper">
									...
									<div class="image-wrapper">
										<img class="img-fluid" src="{{ asset('frontend') }}/image/blog/post-thumbnail-05.jpg" alt="post thumnail">
									</div>
								</div>
							</div>
							<div class="col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="1000">
								  ...
								  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
								    <div class="modal-content">
								      ...
								      <div class="modal-body">
								        ...
								        <div class="row blog-content">
								        	<div class="col-xl-12">
								        		<img class="img-fluid" src="{{ asset('frontend') }}/image/blog/blog_full_06.jpg" alt="blog post image 05">
								        	</div>
								        	<div class="col-xl-8 offset-xl-2">
								        		<div class="content-wrapper">
									        		<h2 class="blog-title">Javascript algorythm and data structure for beginner</h2>
								...
								<div class="content-wrapper">
									...
									<div class="image-wrapper">
										<img class="img-fluid" src="{{ asset('frontend') }}/image/blog/post-thumbnail-06.jpg" alt="post thumnail">
									</div>
								</div>
							</div>
						</div>
				...
				<div class="partnerCarousel">
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="image-wrapper">
								<img src="{{ asset('frontend') }}/image/partner/partner_logo_1.png" alt="partner logo 01">
							</div> <!-- .image-wrapper -->
						</div><!-- .swiper-slide -->
						<div class="swiper-slide">
							<div class="image-wrapper">
								<img src="{{ asset('frontend') }}/image/partner/partner_logo_2.png" alt="partner logo 02">
							</div> <!-- .image-wrapper -->
						</div><!-- .swiper-slide -->
						<div class="swiper-slide">
							<div class="image-wrapper">
								<img src="{{ asset('frontend') }}/image/partner/partner_logo_3.png" alt="partner logo 03">
							</div> <!-- .image-wrapper -->
						</div><!-- .swiper-slide -->
						<div class="swiper-slide">
							<div class="image-wrapper">
								<img src="{{ asset('frontend') }}/image/partner/partner_logo_4.png" alt="partner logo 04">
							</div> <!-- .image-wrapper -->
						</div><!-- .swiper-slide -->
						<div class="swiper-slide">
							<div class="image-wrapper">
								<img src="{{ asset('frontend') }}/image/partner/partner_logo_5.png" alt="partner logo 05">
							</div> <!-- .image-wrapper -->
						</div><!-- .swiper-slide -->
						<div class="swiper-slide">
							<div class="image-wrapper">
								<img src="{{ asset('frontend') }}/image/partner/partner_logo_6.png" alt="partner logo 06">
							</div> <!-- .image-wrapper -->
						</div><!-- .swiper-slide -->
						<div class="swiper-slide">
							<div class="image-wrapper">
								<img src="{{ asset('frontend') }}/image/partner/partner_logo_7.png" alt="partner logo 07">
							</div> <!-- .image-wrapper -->
						</div><!-- .swiper-slide -->
						<div class="swiper-slide">
							<div class="image-wrapper">
								<img src="{{ asset('frontend') }}/image/partner/partner_logo_8.png" alt="partner logo 08">
							</div> <!-- .image-wrapper -->
						</div><!-- .swiper-slide -->
						<div class="swiper-slide">
							<div class="image-wrapper">
								<img src="{{ asset('frontend') }}/image/partner/partner_logo_9.png" alt="partner logo 09">
							</div> <!-- .image-wrapper -->
						</div><!-- .swiper-slide -->
					</div> <!-- .swiper-wrapper -->
				</div> <!-- .partnerCarousel -->
			...
			<footer class="site-footer" id="site-footer">
				<div class="footer-main">
					<div class="row align-items-center justify-content-center">
						<div class="col-lg-6 text-center branding-block">
							<a class="footer-brand" href="#"><img src="{{ asset('frontend') }}/image/fungi_logo.png" alt="Pori logo"></a>
							<p>
				...
				<div class="row footer-bottom">
					<div class="col-md-6">
						<p>All rights reserved &copy; {{ date('Y') }} <strong>CoderS</strong></p>
					</div>
					<div class="col-md-6">
